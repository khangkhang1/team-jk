...
<head>
<meta charset="UTF-8">
<title>주차맵+결제 - 인천공항 주차관리시스템</title>
...
<body class="resPage">
	...
	<header id="topSearch">
		...
		<div id="logo" data-i18n="res_pageTitle">주차맵 + 결제</div>
		<nav id="topNav">
	...
	<div id="resWrap">
		...
		<!-- ① 이용 방식 선택 (1안/2안) + 시간 -->
		<form name="res">
		<details id="stepPlan" class="resStep" open>
			<summary><span data-i18n="res_step1">① 이용 방식 선택</span> <span class="stepSummaryValue" id="planSummary" data-i18n="res_notChosen">선택 안 됨</span></summary>
			<div class="stepBody">
				...
				<div class="formRow plan1Only hidden" id="durationRow">
					...
					<select id="durationInput" name="res_time">
				...
				<fieldset class="plan1Only hidden" id="flightFieldset">
					...
					<div class="formRow">
						...
						<input type="text" name="FlightNumber" id="flightNoInput" placeholder="예: KE001">
					</div>
		...
		<!-- ② 좌석 선택 -->
		<details id="stepSeat" class="resStep">
			<summary><span data-i18n="res_step3">③ 좌석 선택</span> <span class="stepSummaryValue" id="seatSummary" data-i18n="res_notChosen">선택 안 됨</span></summary>
			<div class="stepBody">

				<div id="seatToolbar">
    <div id="floorTabs">
         <button type="button" class="floorTab active" data-floor="1">1층</button>
         <button type="button" class="floorTab" data-floor="2">2층</button>
    </div>
    <div id="floorRemain"><span data-i18n="res_floorRemain">이 층 잔여</span>: <strong id="floorRemainCount">-</strong>석</div>
    <!-- 자바스크립트 에러 방지용 숨김 처리 ID -->
    <button type="button" id="randomAssignBtn" style="display: none;"></button>
			</div>
				<div id="seatLegend">
		...
		<!-- ③ 결제 수단 -->
		<details id="stepPay" class="resStep">
			<summary><span data-i18n="res_step4">④ 결제 수단</span> <span class="stepSummaryValue" id="paySummary" data-i18n="res_notChosen">선택 안 됨</span></summary>
			<div class="stepBody">
