...
/*
	...
	* reservation_parking_start_time : 실제 주차 시작 시각
	* reservation_date 		: 예약 시각
	* reservation_final_amount : 최종 결제 금액
	* reservation_type		: 예약 주차 유형(not null / 1: 예약형 or 2: 자유출차형)
*/
	private int reservation_estimate_amount, reservation_deposit_amount, reservation_final_amount;
	...
	public ReservationInfoDto(String reservation_id, String reservation_status, String reservation_start_date,
			...
			String member_id, String seat_no, int reservation_deposit_amount, String reservation_date) {
		...
		this.reservation_deposit_amount = reservation_deposit_amount;
	...
	public ReservationInfoDto(String reservation_id, String flight_no, String reservation_arrive_datetime, String reservation_status, String reservation_start_date,
		...
		this.member_id = member_id;
		this.seat_no = seat_no;
		this.reservation_estimate_amount = reservation_estimate_amount;
		this.reservation_deposit_amount = reservation_deposit_amount;
		this.reservation_date = reservation_date;
	}
	...
	public int getReservation_estimate_amount() {
		return reservation_estimate_amount;
	}
	public int getReservation_deposit_amount() {
		return reservation_deposit_amount;
	}
	public int getReservation_final_amount() {
		return reservation_final_amount;
	}
	public String getReservation_parking_start_time() {
		return reservation_parking_start_time;
	}
