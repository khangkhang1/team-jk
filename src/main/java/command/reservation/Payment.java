...
public class Payment implements CommonExecute {
	...
	public void execute(HttpServletRequest request) {
		...
		int flight_id = Integer.parseInt(request.getParameter("t_reservation_flight_no"));
		...
		if(plan.equals("1")) {
			r_dto = new ReservationInfoDto(reservation_id, flight_id, "1", start_date, start_time, end_date, end_time, plan, member_id, seat);
		} else {
